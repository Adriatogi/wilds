...
algorithms = ['ERM', 'MI', 'groupDRO', 'deepCORAL', 'IRM', 'DANN', 'AFN', 'FixMatch', 'PseudoLabel', 'NoisyStudent']
...
models = ['resnet18_ms', "vit_b_16", "vit_l_16" 'resnet18', 'resnet34', 'resnet50', 'resnet101', 'wideresnet50',
